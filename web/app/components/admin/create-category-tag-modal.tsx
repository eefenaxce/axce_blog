...
type CreateType = "category" | "tag"

interface CreateCategoryTagModalProps {
  open: boolean
...
export function CreateCategoryTagModal({
  open,
  onOpenChange,
  type,
  onCreated,
}: CreateCategoryTagModalProps) {
  ...
  return (
    <Modal open={open} onOpenChange={handleClose} title={`新建${label}`} size="md">
